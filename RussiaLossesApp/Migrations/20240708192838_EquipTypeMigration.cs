...
{
    /// <inheritdoc />
    public partial class EquipTypeMigration : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                UPDATE LossObject
                SET model = EquipTypes.Name, type = EquipTypes.Category
                FROM LossObject
                INNER JOIN EquipTypes ON LossObject.EquipTypeId = EquipTypes.Id;
        
                DELETE FROM EquipTypes;
            ");
